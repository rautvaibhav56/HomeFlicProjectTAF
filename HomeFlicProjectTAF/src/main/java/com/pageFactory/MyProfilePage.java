...
public class MyProfilePage {
	...
	public void verifyLogoutLinkDisplayed(){
		...
		objPojo.getObjUtilities().logReporter("Verify 'Logout' link is displayed on My profile Page ", objPojo.getObjWrapperSeleniumFunctions().checkElementDisplayed(loc_lnk_Logout));
